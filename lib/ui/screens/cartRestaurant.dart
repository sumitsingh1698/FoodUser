...
class CartRestauranPage extends StatefulWidget {
  final restaurantId;

  CartRestauranPage(this.restaurantId);

  @override
  _CartRestauranPage createState() => new _CartRestauranPage();
}

class _CartRestauranPage extends State<CartRestauranPage> {
  bool _dataLoaded;
  String token;
  ...
  void getData() async {
    ...
    prefs.setDouble('discount', data.restaurant[0].discount);
    setState(() {
      _dataLoaded = true;
    });
    bottomCart();
