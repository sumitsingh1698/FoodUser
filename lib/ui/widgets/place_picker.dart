...
class PlacePickerState extends State<PlacePicker> {
  ...
  /// is fetched.
  static final LatLng initialTarget = LatLng(10.1598078, 76.44508280000002);
  ...
  Future reverseGeocodeLatLng(LatLng latLng) async {
    ...
    setState(() {
      ...
      this.locationResult.name = addresses.first.featureName;
      this.locationResult.locality = addresses.first.locality;
      this.locationResult.latLng = latLng;
      this.locationResult.street = addresses.first.addressLine;
      this.locationResult.state = addresses.first.adminArea;
      this.locationResult.city = addresses.first.subAdminArea;
      this.locationResult.country = addresses.first.countryCode;
      this.locationResult.zip = addresses.first.postalCode;
      loading = false;
    });
  }
          ...
          Expanded(
            child: TextField(
              decoration: InputDecoration(
                hintText: "Search your Store location",
